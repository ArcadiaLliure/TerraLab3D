...
_CLMS_DATASETS = (
    _ClmsDataset(
        ...
        (
            ...
            "low_vegetation.herbaceous.natural_grassland",
            "low_vegetation.moss_lichen",
            "wetland.inland.herbaceous_wetland",
            "wetland.coastal.mangrove",
            "bare_sparse.unspecified",
            "water.unspecified",
            "snow_ice.unspecified",
        ),
        class_translation=(
            (10, "tree_cover.unspecified"),
            (20, "low_vegetation.shrub.shrubland"),
            (30, "low_vegetation.herbaceous.natural_grassland"),
            (40, "agriculture.cropland.unspecified"),
            (50, "wetland.inland.herbaceous_wetland"),
