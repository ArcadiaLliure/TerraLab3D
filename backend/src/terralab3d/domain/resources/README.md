# Capacitat `resources` — recursos binaris i cicle de vida

## 1. Propòsit

Gestionar identitat, versió, propietat, memòria, registre, invalidació i disposició de recursos grans.
...
- **Entrades:** Descriptors binaris, versions, propietaris i pressupostos.
- **Sortides:** Transicions de cicle de vida i descriptors transportables.
...
|---|---|---|---|
| `DatasetState` | Entitat | Estat de recurs/dataset | Esquelet |
| `ResourceDescriptor` | DTO | Handle binari versionat | Esquelet |
| `ResourceLifecycleModel` | Servei | Transicions i invalidació | Esquelet |
