# Capacitat `elevation` — elevacions i DEM

## 1. Propòsit

Modelar mostres d’elevació, grids, CRS, resolució, validesa i transformacions necessàries per horitzó i terreny.
...
- **Entrades:** Ubicació, àrea, resolució, CRS i fonts DEM.
- **Sortides:** Mostres i grids d’elevació tipats amb metadades.
...
|---|---|---|---|
| `ElevationSample` | DTO | Elevació georeferenciada | Esquelet |
| `ElevationGrid` | DTO | Grid regular o polar | Esquelet |
| `ElevationAnalysisCalculator` | Protocol científic | Pendents, normals i interpolació | Esquelet |
