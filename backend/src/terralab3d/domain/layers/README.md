# Capacitat `layers` — capes i visibilitat

## 1. Propòsit

Definir identificadors, dependències, disponibilitat, visibilitat, ordre i polítiques de capes.
...
- **Entrades:** Ordres d’activació, estat de datasets i restriccions.
- **Sortides:** LayerState coherent i esdeveniments de canvi.
...
|---|---|---|---|
| `LayerId` | Enum | Identificador estable | Esquelet |
| `LayerState` | Agregat | Visibilitat i disponibilitat | Esquelet |
| `LayerPolicy` | Servei | Dependències i transicions | Esquelet |
