# Capacitat `selection` — selecció i inspecció

## 1. Propòsit

Aplicar resultats de picking reals, rebutjar generacions obsoletes i mantenir l’estat de selecció independent del renderer.
...
- **Entrades:** PickResult tipat, generació de escena i estat actual.
- **Sortides:** SelectionState immutable i ordres d’enfocament opcionals.
...
|---|---|---|---|
| `PickResult` | DTO | Impacte real del frontend | Esquelet |
| `SelectionState` | Agregat | Selecció autoritativa | Esquelet |
| `SelectionModel` | Servei | Aplicació i caducitat | Esquelet |
...
|---|---|---|---|---|---|---|---|
| `TerraLab/runtime/offscreen_renderer.py; TerraLab/ui/astro_canvas.py` | `picking i decisions de negoci al renderer/UI` | Lògica i comportament actuals | Regles científiques, invariants, fixtures i semàntica útils | Qt, QPainter, diccionaris sense tipus, threads o I/O que no pertanyin al domini | Aïllar, tipar i caracteritzar abans de traslladar | `backend/src/terralab3d/domain/selection` | `REWRITE` |
