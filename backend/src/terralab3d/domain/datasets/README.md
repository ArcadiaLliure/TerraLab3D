# Capacitat `datasets` — datasets, descàrregues i validació

## 1. Propòsit

Modelar manifests, requisits, versions, descàrrega, verificació, instal·lació i mode de reserva de recursos de dades.
...
- **Entrades:** Manifest, font, checksum, versió i ordre de descàrrega.
- **Sortides:** Estat de dataset, progrés, errors i recursos disponibles.
...
|---|---|---|---|
| `DatasetManifest` | Entitat | Identitat i requisits | Esquelet |
| `DatasetInstallation` | Agregat | Estat instal·lat | Esquelet |
| `DatasetValidationModel` | Servei | Checksum, versió i compatibilitat | Esquelet |
