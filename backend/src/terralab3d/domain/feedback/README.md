# Capacitat `feedback` — progrés, errors, mode de reserva i estat visible

## 1. Propòsit

Representar operacions, progrés, advertiments, errors recuperables i estats mode de reserva sense derivar-los de detalls d’implementació.
...
- **Entrades:** Esdeveniments d’aplicació i telemetria tipada.
- **Sortides:** Estat de feedback presentable i accionable.
...
|---|---|---|---|
| `OperationStatus` | Entitat | Estat d’una operació | Esquelet |
| `UserFacingIssue` | DTO | Error/advertiment accionable | Esquelet |
| `FeedbackStateModel` | Servei | Reducció d’esdeveniments | Esquelet |
