# Capacitat `sky_background` — fons celeste, dia, nit i crepuscle

## 1. Propòsit

Calcular els paràmetres científics del cel diürn, nocturn i crepuscular que el shader representarà.
...
- **Entrades:** Posició solar, atmosfera, contaminació lumínica, clima i observador.
- **Sortides:** Paràmetres de luminància, cromaticitat, transició i màscara de cel.
...
|---|---|---|---|
| `SkyBackgroundState` | DTO | Paràmetres físics/visuals del fons | Esquelet |
| `TwilightCalculator` | Protocol científic | Fases i intensitat del crepuscle | Esquelet |
| `SkyBackgroundModel` | Servei | Composició de l’estat del fons | Esquelet |
