# Capacitat `imaging` — simulació fotogràfica

## 1. Propòsit

Modelar sensor, ISO, exposició, saturació, senyal, soroll, traces i previsualització científica de captura.
...
- **Entrades:** Instrument, sensor, exposició, fotometria, atmosfera i moviment celeste.
- **Sortides:** Paràmetres de captura, SNR, saturació i efectes de llarga exposició.
...
|---|---|---|---|
| `ImagingSession` | Agregat | Configuració de captura | Esquelet |
| `ImagingSignalCalculator` | Protocol científic | Senyal, soroll i saturació | Esquelet |
| `ExposurePreviewModel` | Servei | Paràmetres de previsualització | Esquelet |
...
|---|---|---|---|---|---|---|---|
| `TerraLab/widgets/telescope_scope_mode.py; controls de scope` | `ISO/exposició i enquadrament` | Lògica i comportament actuals | Regles científiques, invariants, fixtures i semàntica útils | Qt, QPainter, diccionaris sense tipus, threads o I/O que no pertanyin al domini | Aïllar, tipar i caracteritzar abans de traslladar | `backend/src/terralab3d/domain/imaging` | `EXTRACT` |
| `TerraLab/visual_magnitude_engine.py; TerraLab/physical_math.py` | `guany i magnitud instrumental` | Lògica i comportament actuals | Regles científiques, invariants, fixtures i semàntica útils | Qt, QPainter, diccionaris sense tipus, threads o I/O que no pertanyin al domini | Aïllar, tipar i caracteritzar abans de traslladar | `backend/src/terralab3d/domain/imaging` | `EXTRACT` |
