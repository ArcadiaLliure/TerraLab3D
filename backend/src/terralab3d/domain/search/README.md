# Capacitat `search` — cerca astronòmica

## 1. Propòsit

Indexar i ordenar objectes astronòmics per nom, àlies, identificador o coordenades sense provocar navegació directament.
...
- **Entrades:** Consulta textual/coordenades i índexs tipats.
- **Sortides:** Resultats ordenats amb identificador i coordenades.
...
|---|---|---|---|
| `SearchQuery` | DTO | Consulta normalitzada | Esquelet |
| `SearchResult` | DTO | Resultat ordenat | Esquelet |
| `AstronomicalSearchModel` | Servei | Rànquing d’índexs | Esquelet |
