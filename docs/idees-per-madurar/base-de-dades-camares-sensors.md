...
- Per afinar el [simulador fotogràfic (pas 20)](../pendent/pas20-simulador-fotografic.md), interessaria un selector de model de càmera/sensor d'una llista, que calculés automàticament la mida del marc al cel, estrelles estimades i necessitat de seguiment.
...
Cap directa. És una millora opcional del [pas 20](../pendent/pas20-simulador-fotografic.md), que s'ha de poder completar sense aquesta peça.
