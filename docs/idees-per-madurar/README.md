...
|---|---|---|---|
| [Base de dades de càmeres/sensors](base-de-dades-camares-sensors.md) | Font, llicència, manteniment i esquema del catàleg. | Dataset redistribuïble i política de versió/actualització tancats. | [20 — simulador fotogràfic](../pendent/pas20-simulador-fotografic.md) |
...
| [“Go In” a superfícies planetàries](go-in-superficies-planetaries.md) | Quins cossos, dades, LOD i transició local/global. | Primer cos pilot, dataset i contracte de streaming decidits. | [17 — superfície progressiva](../pendent/pas17-superficie-progressiva.md), [38 — transicions](../pendent/pas38-homologacio-final.md) |
...
| [Transició terreny → planeta esfèric](transicio-terreny-planeta-esferic.md) | Representació global, LOD i continuïtat entre sistemes. | Prototip amb referencials, dades i pressupost sense salts acceptat. | [17 — superfície progressiva](../pendent/pas17-superficie-progressiva.md), [38 — transicions](../pendent/pas38-homologacio-final.md) |
