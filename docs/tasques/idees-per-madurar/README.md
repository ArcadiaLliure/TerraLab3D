...
| [Cometes](cometes.md) | Catàleg, actualització orbital, esdeveniments i model observable. | Font/versionat, propagació, UI i toleràncies resolts. | [22 — observables](../completat/pas22-trajectories-visibilitat.md), [32 — efemèrides](../pendent/pas32-motor-efemerides.md) |
