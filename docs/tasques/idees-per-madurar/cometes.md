...
3. Cometes entren directament com a nou tipus dins el contracte observable del [pas 22](../completat/pas22-trajectories-visibilitat.md) i el grup “dinàmics” del [pas 32](../pendent/pas32-motor-efemerides.md), o necessiten un subsistema propi?
