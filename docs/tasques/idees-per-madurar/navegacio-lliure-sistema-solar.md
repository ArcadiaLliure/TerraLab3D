...
Es relaciona amb la [nau 3D](nau-3d-tercera-persona.md), la [transició terreny → planeta](transicio-terreny-planeta-esferic.md), [Go In](go-in-superficies-planetaries.md) i la [representació del Sol](representacio-del-sol.md). La [vista solar del pas 26](../pendent/pas26-recursos-sistema-solar.md) és navegació dins del gestor i no satisfà aquesta idea física.
