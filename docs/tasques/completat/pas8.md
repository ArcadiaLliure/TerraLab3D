...
> **Estat:** completat. **Estat funcional:** observable. **Origen:** planificat. **Abast vigent:** sol, lluna i planetes amb posicions i aparença reals implementat, verificat i observable en el repositori.
...
Pas 8 completat amb èxit. Consultar el següent pas assenyalat a `docs/README.md`.
