# Pas 15 — Elevació real, perfil d'horitzó i oclusió

> **Estat:** completat. **Estat funcional:** observable. **Origen:** planificat. **Abast vigent:** elevació real, perfil d'horitzó i oclusió implementat, verificat i observable en el repositori.
...
Pas 15 completat amb èxit. Consultar el següent pas assenyalat a `docs/README.md`.
