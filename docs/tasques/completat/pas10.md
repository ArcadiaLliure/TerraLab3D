...
> **Estat:** completat. **Estat funcional:** observable. **Origen:** planificat. **Abast vigent:** via làctia i pols galàctica planck implementat, verificat i observable en el repositori.
...
Pas 10 completat amb èxit. Consultar el següent pas assenyalat a `docs/README.md`.
