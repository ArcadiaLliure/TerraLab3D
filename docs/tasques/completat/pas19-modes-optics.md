...
> **Estat:** completat. **Estat funcional:** observable. **Origen:** planificat. **Abast vigent:** modes d'observació: ull nu, càmera fotogràfica i telescopi/scope implementat, verificat i observable en el repositori.
...
Completar la vertical funcional de «modes d'observació: ull nu, càmera fotogràfica i telescopi/scope» de punta a punta, mantenint la separació de responsabilitats i comprovant-ne el rendiment i funcionament observable.
...
- [Pas 37 — Nomenclàtor GeoNames empaquetat](../pendent/pas37-geonames-empaquetat.md)
- [Pas 38 — Homologació final, recuperació i rendiment](../pendent/pas38-homologacio-final.md)

## Codi existent a reutilitzar

- **Repositori actual:** `CameraRig` és l'única autoritat de pose i FOV visual. El backend ho és dels
...
- [x] Implementació i integració completa de modes d'observació: ull nu, càmera fotogràfica i telescopi/scope.
...
- [x] La cobertura específica inclou números òptics, angle sòlid, pitches quadrats i
- [x] no quadrats, frontera del 2 %, nul·labilitat, vectors dorats del model V1,
- [x] invariància ISO/fotons, persistència/corrupció, interval Gaia, deduplicació,
- [x] top-N global, cancel·lació, overlays, clipping, cercle en píxels, clau
- [x] científica i precedència de traces.
- [x] ### Recorrregut real i captures
- [x] El script reproduïble
- [x] [`capture_step19.mjs`](../../../frontend/tools/capture_step19.mjs) va recórrer
- [x] `eye → camera → telescope → eye` a 1440 × 900 contra l'entrypoint real.
...
- [x] El smoke prolongat va detectar que una primera versió incloïa la generació de
- [x] transformació celeste a la clau Gaia. Es va retirar i es va afegir una prova de
- [x] regressió: cap tick temporal, zoom, resize o DPR torna a consultar Gaia.
...
Pas 19 completat amb èxit. Consultar el següent pas assenyalat a `docs/README.md`.
