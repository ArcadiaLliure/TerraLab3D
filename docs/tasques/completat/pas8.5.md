# Pas 8.5 — Superfície lunar LRO/LOLA, orientació i libració

> **Estat:** completat. **Estat funcional:** observable. **Origen:** planificat. **Abast vigent:** superfície lunar lro/lola, orientació i libració implementat, verificat i observable en el repositori.
...
Pas 8.5 completat amb èxit. Consultar el següent pas assenyalat a `docs/README.md`.
