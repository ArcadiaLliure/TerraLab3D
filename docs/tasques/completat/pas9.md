...
> **Estat:** completat. **Estat funcional:** observable. **Origen:** planificat. **Abast vigent:** eclipsis, ocultacions, separacions i trajectòries implementat, verificat i observable en el repositori.
...
- [Pas 35 — Pestanya d'eclipsis](../pendent/pas35-pestanya-eclipsis.md)
...
Pas 9 completat amb èxit. Consultar el següent pas assenyalat a `docs/README.md`.
