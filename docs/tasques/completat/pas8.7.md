# Pas 8.7 — Il·luminació física de l'escena

> **Estat:** completat. **Estat funcional:** observable. **Origen:** planificat. **Abast vigent:** il·luminació física de l'escena implementat, verificat i observable en el repositori.
...
- [Pas 8.6 — Planetes, anells i satèl·lits naturals](pas8.6.md)
...
- [x] cada frame;
- [x] cada interpolació;
- [x] cada canvi subpixel de shadow camera;
- [x] cada material processat;
- [x] cada actualització normal de uniforms.
...
Pas 8.7 completat amb èxit. Consultar el següent pas assenyalat a `docs/README.md`.
