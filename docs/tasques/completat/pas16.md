# Pas 16 — Terreny 3D retingut, tiles, LOD i picking

> **Estat:** completat. **Estat funcional:** observable. **Origen:** planificat. **Abast vigent:** terreny 3d retingut, tiles, lod i picking implementat, verificat i observable en el repositori.
...
**En depenen:**
- [Pas 17 — Superfície categòrica, estils i refinament visual](pas17-superficie-progressiva.md)
- [Pas 28 — Descobriment de DEM multiproveïdor](../pendent/pas28-dem-multiproveidor.md)
...
Pas 16 completat amb èxit. Consultar el següent pas assenyalat a `docs/README.md`.
