# Pas 31 — “El millor d'aquesta nit” i planificador

> **Estat:** pendent. **Estat funcional:** no implementat. **Origen:** planificat. **Abast vigent:** “el millor d'aquesta nit” i planificador, integració observable i persistència associada.
...
Completar la vertical de «“el millor d'aquesta nit” i planificador» de punta a punta, mantenint la separació de responsabilitats, contractes tipats i integració amb el renderer Three.js sense anticipar capacitats posteriors.
...
- **Repositori actual:** - Temps: [`TimeBar.ts`](../../../frontend/src/view/ui/components/TimeBar.ts) i [`astronomical_event_contracts.ts`](../../../frontend/src/contracts/astronomical_event_contracts.ts).
