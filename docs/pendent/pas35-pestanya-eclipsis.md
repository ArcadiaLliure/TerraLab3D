...
> Estat: **parcial**. El càlcul topocèntric SPICE i les proves d'eclipsis existeixen; falta exposar-los com a tercera pestanya del cercador.
...
- [Pas 9 — motor SPICE d'eclipsis](../completat/pas9.md).
- [Pas 33 — cercador multipestanya](pas33-cercador-objectes-efemerides.md).
- [Pas 34 — previews](pas34-previsualitzacions-efemerides.md), només per a la miniatura opcional.
...
- Domini: [`eclipses/models.py`](../../backend/src/terralab3d/domain/eclipses/models.py), [`eclipses/calculations.py`](../../backend/src/terralab3d/domain/eclipses/calculations.py) i [`eclipses/services.py`](../../backend/src/terralab3d/domain/eclipses/services.py).
