# Pas 33 — Cercador multipestanya d'objectes i efemèrides

> Estat: **parcial**. La cerca d'objectes i el panell existeixen; falta la pestanya d'efemèrides i un contracte de consulta/resultats compartit.
...
- [Pas 31 — planificador](pas31-millor-nit-planificador.md).
...
- Backend: [`search_coordinator.py`](../../backend/src/terralab3d/application/search_coordinator.py), [`search/indexer.py`](../../backend/src/terralab3d/domain/search/indexer.py) i [`search/services.py`](../../backend/src/terralab3d/domain/search/services.py).
