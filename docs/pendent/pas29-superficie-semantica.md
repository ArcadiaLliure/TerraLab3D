# Pas 29 — Superfície semàntica, TLST i refinament sota demanda

> Estat: **parcial**. Hi ha cobertura categòrica, adaptadors de superfície i textures per tile, però TLST i l'arbre de refinament semàntic encara no existeixen com a implementació operativa.
...
- Domini: [`surface/land_cover.py`](../../backend/src/terralab3d/domain/surface/land_cover.py), [`surface/models.py`](../../backend/src/terralab3d/domain/surface/models.py) i [`surface/services.py`](../../backend/src/terralab3d/domain/surface/services.py).
